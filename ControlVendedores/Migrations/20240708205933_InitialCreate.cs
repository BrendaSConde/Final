...
namespace ControlVendedores.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SucursalVendedor", x => new { x.SucursalesId, x.VendedoresId });
                    table.ForeignKey(
                        name: "FK_SucursalVendedor_Sucursal_SucursalesId",
                        column: x => x.SucursalesId,
                        principalTable: "Sucursal",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SucursalVendedor_Vendedor_VendedoresId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    NumTicket = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SucursalVendedor_VendedoresId",
                table: "SucursalVendedor",
                column: "VendedoresId");
